...
<form name="delFrm"
	action="${pageContext.request.contextPath }/noticeinDelete.do"
	method="post">
	<input type="hidden" name="id">
</form>

<form action="${pageContext.request.contextPath }/noticeinUpdate.do"
	method="post">
		...
		<tbody>
			...
			<tr>
				...
				<td><textarea class="form-control" name="content" cols="20"
						rows="3">${notice.noticeContent}</textarea></td>
			</tr>
			<tr>
				<th>작성일시</th>
